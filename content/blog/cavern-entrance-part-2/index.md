...
In this post we'll be adding the rest of the foam structure to our cavern entrance, as you see above, building around [the arch that we made in part 1](../cavern-entrance-part-1).

Here is the final piece that we're working towards:

![final-final](../cavern-entrance-part-1/final-final.jpg)

And here is what we have so far, just the arch:
